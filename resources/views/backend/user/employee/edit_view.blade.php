                    ...
                    <div class="col-md-6">
                        ...
                        <div class="col-md-12">
                            <div class="form-group mb-3">
                                ...
                                <select name="country" class="form-control ot-form-control ot-input select2 w-100"
                                    id="_country_id" required >
                                    <option selected value="{{ $data['show']->country_id }}">{{ @$data['show']->country->name }} </option>
                                </select>
                        ...
                        <div class="col-md-12">
                            <div class="form-group mb-3">
                                ...
                                <input type="date" name="joining_date" autocomplete="off"
                                    class="form-control ot-form-control ot-input" value="{{ $data['show']->joining_date }}"
                                    required>
